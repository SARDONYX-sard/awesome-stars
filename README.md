...
- [jkevin/PS3EyeDirectShow](https://github.com/jkevin/PS3EyeDirectShow) - DirectShow source filter for PS3 Eye via WinUSB
...
- [pigweed-project/pigweed](https://github.com/pigweed-project/pigweed) - Modern software development for embedded systems
...
- [larkmjc/riscv-meta](https://github.com/larkmjc/riscv-meta) - RISC-V Instruction Set Metadata
...
- [VHDL-LS/rust_hdl](https://github.com/VHDL-LS/rust_hdl) - A fast VHDL language server and analysis library written in Rust
...
- [walkframe/gridsheet](https://github.com/walkframe/gridsheet) - A programmable spreadsheet engine for frontend apps with formulas, async computation, and spill support. React-first with a framework-agnostic core.
...
- [aspida/pathpida](https://github.com/aspida/pathpida) - TypeScript friendly internal link client for Next.js and Vinext.
...
- [tommitytom/RetroPlug](https://github.com/tommitytom/RetroPlug) - A frontend for the SameBoy Game Boy and Mesen NES emulators, with a focus on music creation. It runs standalone and can be used as an audio plugin (CLAP / VST3 / VST2 / AU) in your favourite DAW!
